  ...
  var methods = {
      init: function (options) {
        ...
        return this.each(function () {
          ...
          var loop = p.loop, strWrap = $(this).addClass('str_wrap'), fMove = false;
          ...
          var code = function () {
            ...
            var strMove = $('.str_move', strWrap).addClass('str_origin'), strMoveClone = strMove.clone(true).removeClass('str_origin').addClass('str_move_clone'), time = 0;
            if (!p.hoverstop) {
              strWrap.addClass('noStop');
            }
            var circCloneHor = function () {
              strMoveClone.clone(true).css({
                left: '100%',
                right: 'auto',
                width: strMove.width()
              }).appendTo(strMove);
            ...
            if (p.direction == 'left') {
              ...
              if (strMove.width() > strWrap.width()) {
                ...
                var strMoveLeft = strWrap.width(), k1 = 0, timeFunc1 = function () {
                    var fullS = Math.abs(leftPos), time = fullS / p.scrollamount * 1000;
                  ...
                  if (p.drag) {
                    strWrap.on('mousedown', function (e) {
                      ...
                      $(this).on('mousemove', function (e) {
                        ...
                        strMove.stop(true).css({ left: dragLeft });  //drag
                      }).on('mouseup', function () {
                        $(this).off('mousemove');
                        if (p.inverthover) {
                ...
                if (p.runshort) {
                  strMove.css({ left: strWrap.width() });
                  var strMoveLeft = strWrap.width(), k1 = 0, timeFunc = function () {
            ...
            if (p.direction == 'up') {
              ...
              if (strMove.height() > strWrap.height()) {
                ...
                var k2 = 0;
                timeFunc = function () {
                  var fullS = Math.abs(topPos), time = fullS / p.scrollamount * 1000;
                  ...
                  if (p.drag) {
                    strWrap.on('mousedown', function (e) {
                      ...
                      $(this).on('mousemove', function (e) {
                        ...
                        strMove.stop(true).css({ top: dragTop });  //drag
                      }).on('mouseup', function () {
                        if (p.inverthover) {
                          strMove.trigger('mouseenter');
                        }
