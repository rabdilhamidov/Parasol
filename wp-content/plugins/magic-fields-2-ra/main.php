<?php
/*
Plugin Name: Magic Fields +RA
Plugin URI: 
Description: Create custom fields for your post types. Modifing by R. Abdilkamidov to filter fields by post category.
Version: 2.2.2.2
Author:  Hunk and Gnuget + R. Abdilkamidov
Author URI: 
License: GPL2
*/
